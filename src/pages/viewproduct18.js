...
const MIN_RATING=1;
const myLoader=({src})=>{
    return "https://bit.ly/3nIe0PI";
  }
  const myLoader1=({src})=>{
    return "https://bit.ly/3jJfKak";
  }
  const myLoader2=({src})=>{
    return "https://bit.ly/3CtwlGn";
  }
  const myLoader3=({src})=>{
    return "https://bit.ly/3bmAjoE";
  }
            ...
            <div className='flex space-y-10  bg-white p-10 shadow-md'>
                ...
                <div className="flex-grow m-5 shadow-sm">
                    <div className='flex flex-col p-5 space-y-10 bg-white'>
                        <h1 className="text-3xl border-b pb-4 font-bold">MBJ Women's Solid Short Sleeve Boat Neck V </h1>
                       
                        <h1 className="text-1xl ">95% RAYON 5% SPANDEX, Made in USA or Imported, Do Not Bleach, Lightweight fabric with great stretch for comfort, Ribbed on sleeves and neckline / Double stitching on bottom hem</h1>
                        ...
                        <div className='flex space-y-10  bg-white p-10 shadow-md'>
                            ...
                            loader={myLoader} src="https://bit.ly/3nIe0PI"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                            ...
                            loader={myLoader2} src="https://bit.ly/3CtwlGn"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                            ...
                            loader={myLoader3} src="https://bit.ly/3bmAjoE"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                            ...
                            loader={myLoader1} src="https://bit.ly/3jJfKak"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                        ...
                        <h1 className="text-xs text-green-600  "><b className="text-red-500 text-4xl">₹ 9.85</b> <strike className="text-gray-600 text-xs">₹ 509.95</strike> <b>(50% off)</b></h1>
