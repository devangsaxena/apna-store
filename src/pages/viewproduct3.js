...
const MIN_RATING=1;
const myLoader=({src})=>{
    return "https://bit.ly/2XY2uqO";
  }
  const myLoader1=({src})=>{
    return "https://bit.ly/3GsQuyS";
  }
  const myLoader2=({src})=>{
    return "https://bit.ly/3mpTe8m";
  }
  const myLoader3=({src})=>{
    return "https://bit.ly/3BjqPoF";
  }
            ...
            <div className='flex space-y-10  bg-white p-10 shadow-md'>
                ...
                <div className="flex-grow m-5 shadow-sm">
                    <div className='flex flex-col p-5 space-y-10 bg-white'>
                        <h1 className="text-3xl border-b pb-4 font-bold">Mens Cotton Jacket</h1>
                       
                        
                        <h1 className="text-1xl ">great outerwear jackets for Spring/Autumn/Winter, suitable for many occasions, such as working, hiking, camping, mountain/rock climbing, cycling, traveling or other outdoors. Good gift choice for you or your family member. A warm hearted love to Father, husband or son in this thanksgiving or Christmas Day.  </h1>
                        ...
                        <div className='flex space-y-10  bg-white p-10 shadow-md'>
                            ...
                            loader={myLoader} src="https://bit.ly/2XY2uqO"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                            <Image 
                                ...
                                loader={myLoader1} src="https://bit.ly/3GsQuyS"
                                width={920}
                                height={950}
                                objectFit="contain" 
                            />
                            ...
                            loader={myLoader2} src="https://bit.ly/3mpTe8m"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                            ...
                            loader={myLoader3} src="https://bit.ly/3BjqPoF"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                        ...
                        <h1 className="text-xs text-green-600  "><b className="text-red-500 text-4xl">₹ 55.99</b> <strike className="text-gray-600 text-xs">₹ 509.95</strike> <b>(50% off)</b></h1>
