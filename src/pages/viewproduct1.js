...
const MIN_RATING=1;
const myLoader=({src})=>{
    return "https://bit.ly/3nDKVVJ";
  }
  const myLoader1=({src})=>{
    return "https://bit.ly/3BlXBW1";
  }
  const myLoader2=({src})=>{
    return "https://bit.ly/3nCTY9n";
  }
  const myLoader3=({src})=>{
    return "https://bit.ly/2ZIo4Ae";
  }
            ...
            <div className='flex space-y-10  bg-white p-10 shadow-md'>
                ...
                <div className="flex-grow m-5 shadow-sm">
                    <div className='flex flex-col p-5 space-y-10 bg-white'>
                        <h1 className="text-3xl border-b pb-4 font-bold">Fjallraven - Foldsack No. 1 Backpack, Fits 15 Laptops</h1>
                        
                        
                        <h1 className="text-1xl ">Your perfect pack for everyday use and walks in the forest. Stash your laptop (up to 15 inches) in the padded sleeve, your everyday</h1>
                        ...
                        <div className='flex space-y-10  bg-white p-10 shadow-md'>
                            ...
                            loader={myLoader} src="https://bit.ly/3nDKVVJ"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                            <Image 
                                ...
                                loader={myLoader1} src="https://bit.ly/3BlXBW1"
                                width={920}
                                height={950}
                                objectFit="contain" 
                            />
                            ...
                            loader={myLoader2} src="https://bit.ly/3nCTY9n"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                            ...
                            loader={myLoader3} src="https://bit.ly/2ZIo4Ae"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                        ...
                        <h1 className="text-xs text-green-600  "><b className="text-red-500 text-4xl">₹ 109.95</b> <strike className="text-gray-600 text-xs">₹ 509.95</strike> <b>(50% off)</b></h1>
