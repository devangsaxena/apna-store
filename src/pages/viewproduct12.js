...
const MIN_RATING=1;
const myLoader=({src})=>{
    return "https://bit.ly/3bpcTPn";
  }
  const myLoader1=({src})=>{
    return "https://bit.ly/3vUZXdm";
  }
  const myLoader2=({src})=>{
    return "https://bit.ly/3Bq0OUF";
  }
  const myLoader3=({src})=>{
    return "https://bit.ly/3bjOavV";
  }
            ...
            <div className='flex space-y-10  bg-white p-10 shadow-md'>
                ...
                <div className="flex-grow m-5 shadow-sm">
                    <div className='flex flex-col p-5 space-y-10 bg-white'>
                        <h1 className="text-3xl border-b pb-4 font-bold">WD 4TB Gaming Drive Works with Playstation 4 Portable External Hard Drive</h1>
                       
                        <h1 className="text-1xl ">Expand your PS4 gaming experience, Play anywhere Fast and easy, setup Sleek design with high capacity, 3-year manufacturer's limited warranty</h1>
                        ...
                        <table class="table-auto">
                            ...
                            <tr>
                                <td>Type</td>
                                <td>Gaming External Hard Drive</td>
                                <td></td>
                            </tr>
                        ...
                        <div className='flex space-y-10  bg-white p-10 shadow-md'>
                            ...
                            loader={myLoader} src="https://bit.ly/3bpcTPn"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                            <Image 
                                ...
                                loader={myLoader1} src="https://bit.ly/3vUZXdm"
                                width={920}
                                height={950}
                                objectFit="contain" 
                            />
                            <Image 
                                ...
                                loader={myLoader3} src="https://bit.ly/3bjOavV"
                                width={920}
                                height={950}
                                objectFit="contain" 
                            />
                            ...
                            loader={myLoader2} src="https://bit.ly/3Bq0OUF"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                        ...
                        <h1 className="text-xs text-green-600  "><b className="text-red-500 text-4xl">₹ 109.95</b> <strike className="text-gray-600 text-xs">₹ 114.00</strike> <b>(50% off)</b></h1>
