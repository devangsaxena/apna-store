...
const MIN_RATING=1;
const myLoader=({src})=>{
    return "https://bit.ly/316pdSx";
  }
  const myLoader1=({src})=>{
    return "https://wish.link/3CmjlCu";
  }
  const myLoader2=({src})=>{
    return "https://bit.ly/2ZClz2k";
  }
  const myLoader3=({src})=>{
    return "https://bit.ly/3CpNReU";
  }
            ...
            <div className='flex space-y-10  bg-white p-10 shadow-md'>
                ...
                <div className="flex-grow m-5 shadow-sm">
                    <div className='flex flex-col p-5 space-y-10 bg-white'>
                        <h1 className="text-3xl border-b pb-4 font-bold">Pierced Owl Rose Gold Plated Stainless Steel Double</h1>
                       
                        <h1 className="text-1xl ">Rose Gold Plated Double Flared Tunnel Plug Earrings. Made of 316L Stainless Steel</h1>
                        ...
                        <table class="table-auto">
                            ...
                            <tr>
                                <td>Type</td>
                                <td>Double Stainless Steel Pierced Rings</td>
                                <td></td>
                            </tr>
                        ...
                        <div className='flex space-y-10  bg-white p-10 shadow-md'>
                            ...
                            loader={myLoader} src="https://bit.ly/316pdSx"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                            <Image 
                                ...
                                loader={myLoader1} src="https://wish.link/3CmjlCu"
                                width={920}
                                height={950}
                                objectFit="contain" 
                            />
                            ...
                            loader={myLoader2} src="https://bit.ly/2ZClz2k"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                            ...
                            loader={myLoader3} src="https://bit.ly/3CpNReU"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                        ...
                        <h1 className="text-xs text-green-600  "><b className="text-red-500 text-4xl">₹ 10.99</b> <strike className="text-gray-600 text-xs">₹ 509.95</strike> <b>(50% off)</b></h1>
