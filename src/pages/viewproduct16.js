...
const MIN_RATING=1;
const myLoader=({src})=>{
    return "https://bit.ly/3mqEm9D";
  }
  const myLoader1=({src})=>{
    return "https://bit.ly/3mpbWNd";
  }
  const myLoader2=({src})=>{
    return "https://bit.ly/3GxAwDw";
  }
  const myLoader3=({src})=>{
    return "https://bit.ly/2ZI5SH9";
  }
            ...
            <div className='flex space-y-10  bg-white p-10 shadow-md'>
                ...
                <div className="flex-grow m-5 shadow-sm">
                    <div className='flex flex-col p-5 space-y-10 bg-white'>
                        <h1 className="text-3xl border-b pb-4 font-bold">Lock and Love Women's Removable Hooded Faux Leather Moto Biker Jacket</h1>
                       
                        <h1 className="text-1xl ">100% POLYURETHANE(shell) 100% POLYESTER(lining) 75% POLYESTER 25% COTTON (SWEATER), Faux leather material for style and comfort / 2 pockets of front, 2-For-One Hooded denim style faux leather jacket, Button detail on waist / Detail stitching at sides, HAND WASH ONLY / DO NOT BLEACH / LINE DRY / DO NOT IRON</h1>
                        ...
                        <div className='flex space-y-10  bg-white p-10 shadow-md'>
                            ...
                            loader={myLoader} src="https://bit.ly/3mqEm9D"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                            ...
                            loader={myLoader2} src="https://bit.ly/3GxAwDw"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                            ...
                            loader={myLoader3} src="https://bit.ly/2ZI5SH9"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                            ...
                            loader={myLoader1} src="https://bit.ly/3mpbWNd"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                        ...
                        <h1 className="text-xs text-green-600  "><b className="text-red-500 text-4xl">₹ 29.95</b> <strike className="text-gray-600 text-xs">₹ 509.95</strike> <b>(50% off)</b></h1>
