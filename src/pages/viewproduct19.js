...
const MIN_RATING=1;
const myLoader=({src})=>{
    return "https://bit.ly/3Erzze7";
  }
  const myLoader1=({src})=>{
    return "https://bit.ly/3nHSURt";
  }
  const myLoader2=({src})=>{
    return "https://bit.ly/3vTSBa2";
  }
  const myLoader3=({src})=>{
    return "https://bit.ly/3vYlamB";
  }
            ...
            <div className='flex space-y-10  bg-white p-10 shadow-md'>
                ...
                <div className="flex-grow m-5 shadow-sm">
                    <div className='flex flex-col p-5 space-y-10 bg-white'>
                        <h1 className="text-3xl border-b pb-4 font-bold">Opna Women's Short Sleeve Moisture</h1>
                       
                        
                        <h1 className="text-1xl ">100% Polyester, Machine wash, 100% cationic polyester interlock, Machine Wash & Pre Shrunk for a Great Fit, Lightweight, roomy and highly breathable with moisture wicking fabric which helps to keep moisture away, Soft Lightweight Fabric with comfortable V-neck collar and a slimmer fit, delivers a sleek, more feminine silhouette and Added Comfort</h1>
                        ...
                        <div className='flex space-y-10  bg-white p-10 shadow-md'>
                            ...
                            loader={myLoader} src="https://bit.ly/3Erzze7"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                            <Image 
                                ...
                                loader={myLoader1} src="https://bit.ly/3nHSURt"
                                width={920}
                                height={950}
                                objectFit="contain" 
                            />
                            ...
                            loader={myLoader2} src="https://bit.ly/3vTSBa2"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                            ...
                            loader={myLoader3} src="https://bit.ly/3vYlamB"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                        ...
                        <h1 className="text-xs text-green-600  "><b className="text-red-500 text-4xl">₹ 7.95</b> <strike className="text-gray-600 text-xs">₹ 509.95</strike> <b>(50% off)</b></h1>
