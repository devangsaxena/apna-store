...
const MIN_RATING=1;
const myLoader=({src})=>{
    return "https://bit.ly/3bkYd3w";
  }
  const myLoader1=({src})=>{
    return "https://bit.ly/3pPZDvw";
  }
  const myLoader2=({src})=>{
    return "https://bit.ly/3jP48Tb";
  }
  const myLoader3=({src})=>{
    return "https://bit.ly/312E1Sa";
  }
            ...
            <div className='flex space-y-10  bg-white p-10 shadow-md'>
                ...
                <div className="flex-grow m-5 shadow-sm">
                    <div className='flex flex-col p-5 space-y-10 bg-white'>
                        <h1 className="text-3xl border-b pb-4 font-bold">Silicon Power 256GB SSD 3D NAND A55 SLC Cache Performance Boost SATA III 2.5</h1>
                       
                        <h1 className="text-1xl ">3D NAND flash are applied to deliver high transfer speeds Remarkable transfer speeds that enable faster bootup and improved overall system performance. The advanced SLC Cache Technology allows performance boost and longer lifespan 7mm slim design suitable for Ultrabooks and Ultra-slim notebooks. Supports TRIM command, Garbage Collection technology, RAID, and ECC (Error Checking & Correction) to provide the optimized performance and enhanced reliability.</h1>
                        ...
                        <div className='flex space-y-10  bg-white p-10 shadow-md'>
                            ...
                            loader={myLoader} src="https://bit.ly/3bkYd3w"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                            <Image 
                                ...
                                loader={myLoader1} src="https://bit.ly/3pPZDvw"
                                width={920}
                                height={950}
                                objectFit="contain" 
                            />
                            ...
                            loader={myLoader2} src="https://bit.ly/3jP48Tb"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
                            ...
                            loader={myLoader3} src="https://bit.ly/312E1Sa"
                            width={920}
                            height={950}
                            objectFit="contain" 
                            />
